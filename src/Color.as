...
[Setting hidden] bool S_ColorMapNames        = true;
...
[Setting hidden] vec3 S_ColorModeWeekly      = vec3(0.0f,  0.6f,  1.0f);
...
namespace Color {
    string Get(Map::Medal medal) {
        switch (medal) {
            case Map::Medal::Unplayed:
            case Map::Medal::None:
                return colorMedalNone;

            case Map::Medal::Bronze:
                return colorMedalBronze;

            case Map::Medal::Silver:
                return colorMedalSilver;

            case Map::Medal::Gold:
                return colorMedalGold;

            case Map::Medal::Author:
                return colorMedalAuthor;

#if DEPENDENCY_WARRIORMEDALS
            case Map::Medal::Warrior:
                return colorMedalWarrior;
#endif
    ...
    string Get(int medals) {
        return Get(Map::Medal(medals));
    }

    string Get(Campaign::Type type) {
        switch (type) {
            case Campaign::Type::Seasonal:
                return colorModeSeasonal;

            case Campaign::Type::Club:
                return colorModeClub;

            case Campaign::Type::Custom:
                return colorModeCustom;

            case Campaign::Type::Tmx:
                return colorModeTmx;

            case Campaign::Type::Totd:
    ...
    void SetMedal() {
#if DEPENDENCY_WARRIORMEDALS
        colorMedalWarrior = WarriorMedals::GetColorStr();
#endif
